...
namespace SmartHoldemNet.Service.Transaction.Tests
{
    ...
    public class TransactionServiceAsyncTests : TransactionServiceTestsBase
    {
        ...
        {
            var trans = await TransactionService.GetTransactionsAsync(new SmartHoldemTransactionRequest { BlockId = base._blockId });
        ...
        {
            var trans = await TransactionService.GetUnconfirmedTransactionsAsync(new SmartHoldemUnconfirmedTransactionRequest());
