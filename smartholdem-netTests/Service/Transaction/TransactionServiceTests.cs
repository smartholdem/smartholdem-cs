...
namespace SmartHoldemNet.Service.Transaction.Tests
{
    ...
    public class TransactionServiceTests : TransactionServiceTestsBase
    {
        ...
        {
            var trans = TransactionService.GetTransactions(new SmartHoldemTransactionRequest { BlockId = base._blockId });
        ...
        {
            var trans = TransactionService.GetUnconfirmedTransactions(new SmartHoldemUnconfirmedTransactionRequest());
